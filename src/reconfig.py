...
param_mid_cmd = [" -r 5 -i 25 -tolerance 0.001", # 0-MART
                 ...
                 " -metric2t NDCG@10 -round 500 -tolerance 0.002 -max 5", # 3-AdaRank (list-wise)
                 " -metric2t NDCG@10 -r 5 -i 25 -tolerance 0.001 ", # 4-Coordinate Ascent (list-wise)
                 " -metric2t NDCG@10 -r 5 -i 25 -tolerance 0.001 ", # 6-LambdaMart (list-wise)
                 "", # 7-ListNet (list-wise)
